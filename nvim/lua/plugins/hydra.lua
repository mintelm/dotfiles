...
local function config()
    ...
    hydra({
        ...
        heads = {
            ...
            { 'c',     function() delayed_centering_cmd('DapContinue', 100) end },
            { 's',     function() delayed_centering_cmd('DapStepOver', 100) end },
            { 'i',     function() delayed_centering_cmd('DapStepInto', 100) end },
            { 'o',     function() delayed_centering_cmd('DapStepOut', 100) end },
            { 'r',     function() delayed_centering_cmd('DapToggleRepl', 100) end },
